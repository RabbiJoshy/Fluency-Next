...
const CACHE_NAME = 'flashcards-v336';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260908c',
  '/css/light-theme.css?v=20260828a',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260908c',
  ...
  '/js/auth.js?v=20260827a',
  '/js/about-example.js?v=20260908c',
