"""Sense-menu data contract: leaves, analyses, and their identities.

Lives outside ``fluency.wsd`` because it describes the artifact stage 02
produces, not anything the classifier does with it. Keeping it here means a
sense menu can be built, validated and released without the WSD package
importing cleanly -- which matters because WSD is optional enrichment and runs
two stages later.
"""
