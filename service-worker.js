...
const urlsToCache = [
  ...
  '/Fluency-Next/js/main.js?v=20260825ak',
  ...
  '/Fluency-Next/js/auth.js?v=20260823ae',
  `/Fluency-Next/js/about-example.js?v=${ASSET_VERSION}`,
  `/Fluency-Next/js/spotify.js?v=${ASSET_VERSION}`,
  `/Fluency-Next/js/estimation.js?v=${ASSET_VERSION}`,
  '/Fluency-Next/js/config.js?v=20260823ad',
