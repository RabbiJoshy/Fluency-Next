...
const CACHE_NAME = 'flashcards-v329';
...
const urlsToCache = [
  '/',
  '/index.html',
  '/css/style.css?v=20260831a',
  '/css/light-theme.css?v=20260828a',
  '/config/config.json',
  '/config/cefr_levels.json',
  '/config/offline-content-manifest.json',
  '/js/main.js?v=20260905a',
